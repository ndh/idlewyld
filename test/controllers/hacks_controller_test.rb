...
class HacksControllerTest < ActionController::TestCase
  ...
  test "should create hack" do
    assert_difference('Hack.count') do
      post :create, hack: { backlog_location: @hack.backlog_location, description: @hack.description, name: @hack.name, product_owner: @hack.product_owner }
    end
  ...
  test "should update hack" do
    patch :update, id: @hack, hack: { backlog_location: @hack.backlog_location, description: @hack.description, name: @hack.name, product_owner: @hack.product_owner }
    assert_redirected_to hack_path(assigns(:hack))
  end
